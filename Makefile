...
lint-py:  ## run python linter with ruff
	python -m ruff check jupyterlab_singleton_provider
	python -m ruff format --check jupyterlab_singleton_provider
...
fix-py:  ## fix python formatting with ruff
	python -m ruff check --fix jupyterlab_singleton_provider
	python -m ruff format jupyterlab_singleton_provider
...
test-py:  ## run python tests
	python -m pytest -v jupyterlab_singleton_provider/tests

# alias
tests-py: test-py

coverage-py:  ## run python tests and collect test coverage
	python -m pytest -v jupyterlab_singleton_provider/tests --cov=jupyterlab_singleton_provider --cov-report term-missing --cov-report xml
